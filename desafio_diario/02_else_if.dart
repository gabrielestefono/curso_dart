// Contexto:
/* Você está criando um programa para uma biblioteca que precisa classificar
    livros de acordo com a faixa etária dos leitores. 
...
void main() {
  ...
  if (idadeLeitor >= idadeMinima) {
    print("Acesso permitido");
  } else if (idadeLeitor >= (idadeMinima - 3) && idadeLeitor < idadeMinima) {
